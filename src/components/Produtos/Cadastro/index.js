...
function Cadastro() {
    ...
    const handleKeyUp = useCallback((e) => {
        ...
        if(e.target.name === 'price'){
            ...
            // \D Tudo que não for numérico
            // g Procurar em todo o conteúdo, mesmo que ache, continue
    ...
    return <Container>
        ...
        <Form>
            ...
            <Input placeholder="Preço de Venda" onChange={handleChange} name="price" value={product.price} onKeyUp={handleKeyUp} />
